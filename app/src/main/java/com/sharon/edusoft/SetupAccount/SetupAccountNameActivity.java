    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(SetupAccountNameActivity.this, SetupAccountImageActivity.class);
            ...
            mDatabase.child("users").child(user_id).updateChildren(mDataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Intent setupImageIntent = new Intent(SetupAccountNameActivity.this, SetupAccountUsernameActivity.class);
